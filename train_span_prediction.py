...
def main():
    ...
    train_dataset = SpanDataset('data/span/train.jsonl', tokenizer, item_filter, extra_tokenizer_kwargs)
    # train_dataset = CombinedDataset(
    #     SpanDataset('data/span/val.jsonl', tokenizer, item_filter, extra_tokenizer_kwargs),
    #     SpanDataset('data/span/test.jsonl', tokenizer, item_filter, extra_tokenizer_kwargs),
    # )
    # train_dataset = SpanDataset('data/span/full.jsonl', tokenizer, item_filter, extra_tokenizer_kwargs)
